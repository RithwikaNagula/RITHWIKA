/**
 * Test Suite for quote-generatecomponent
...
// Test suite for checking the rendering and logic of QuoteGenerateComponent
import { ComponentFixture, TestBed } from '@angular/core/testing';
import { QuoteGenerateComponent } from './quote-generatecomponent';
...
describe('QuoteGenerateComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      imports: [QuoteGenerateComponent],
